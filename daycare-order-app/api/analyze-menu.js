...
표의 열 순서: 날짜 | 열량/단백질 | 오전간식 | 중식 | 오후간식
건너뛸 행: 주말(토·일), 공휴일

각 날짜의 오전간식·중식·오후간식 메뉴명과 주요 식재료를 추출하세요.

식재료 기준:
- 포함: 채소류, 육류(돼지/소/닭/오리), 생선·해산물, 두부·콩류, 버섯류, 달걀, 된장·고추장·간장
- 제외: 소금·설탕·식용유·밀가루·전분 등 기본 조미료
- 같은 날 중복 재료는 한 번만, 재료명은 간결하게
